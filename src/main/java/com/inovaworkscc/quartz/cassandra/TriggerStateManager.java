...
import static com.inovaworkscc.quartz.cassandra.JobConverter.JOB_ID;
...
import com.inovaworkscc.quartz.cassandra.util.GroupHelper;
import com.inovaworkscc.quartz.cassandra.util.TriggerGroupHelper;
...
public class TriggerStateManager {
    ...
    public void pause(TriggerKey triggerKey) {
        triggerDao.setState(triggerKey, Constants.STATE_PAUSED, false);
    }
    ...
    public Collection<String> pause(GroupMatcher<TriggerKey> matcher) {
        ...
        final GroupHelper groupHelper = new GroupHelper(triggerDao, queryHelper);
    ...
    public void pauseJob(JobKey jobKey) {
        final String jobId = jobDao.getJob(jobKey).getString(JOB_ID);
        final TriggerGroupHelper groupHelper = new TriggerGroupHelper(triggerDao, queryHelper);
    ...
    public void resume(TriggerKey triggerKey) {
        ...
        triggerDao.setState(triggerKey, Constants.STATE_WAITING, false);
    }
